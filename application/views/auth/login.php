...
<head>
    ...
    <title><?php echo lang('login'); ?> - <?php echo lang('doctor_care'); ?></title>
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="auth/login">
        <h2 class="login form-signin-heading"><?php echo lang('doctor_care'); ?><br/><br/><img alt="" src="uploads/favicon.png"></h2>
